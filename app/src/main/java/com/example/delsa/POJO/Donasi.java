...
public class Donasi implements Parcelable {
    ...
    private String idDonasi, idUser, idBencana, nominal, kodeunik, totalpembayaran, metodepembayaran,pesan, bataspembayaran, foto;
    private boolean anonim, terbayar;

    public Donasi() {
    }

    public Donasi(String idDonasi, String idUser, String idBencana, String nominal, String kodeunik, String totalpembayaran, String metodepembayaran, String pesan, String bataspembayaran, String foto, boolean anonim, boolean terbayar) {
